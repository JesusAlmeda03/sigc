...
/** Funciones **/
	...
	function get_lista( $id ) {
		...
		$this->db->order_by('au_lista_verificacion.Requisito');
	...
	function get_respuestas_lista( $id_auditoria, $id_proceso ) {
		if( $this->session->userdata( 'id_area') != 9 ) {
			...
			$this->db->join( 'au_lista_verificacion', 'au_lista_verificacion.IdListaVerificacion = au_lista_verificacion_usuario.IdListaVerificacion' );
			$this->db->select( 'au_respuestas_lista.IdRespuestaLista, au_respuestas_lista.IdListaVerificacionUsuario, au_respuestas_lista.IdProceso, au_respuestas_lista.Tipo, au_respuestas_lista.Hallazgo, au_procesos.Proceso, au_lista_verificacion.Requisito' );
