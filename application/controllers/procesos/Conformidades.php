...
class Conformidades extends CI_Controller {
		...
		switch( $avance ) {
			...
			case 1 :
				...
				if ($_POST){
					...
					$aCont = $this -> input -> post('aCont');
					$evidencia = $this->input->post('evidencia');
					$this -> conformidades_model -> inserta_contencion ($id, $aCont, $evidencia);
				}
				break;
		...
		switch( $edo ) {
			...
			case 1 :
				...
				if ($seguimiento -> num_rows() > 0) {
					...
					$datos['aCont']	   = $this -> conformidades_model -> get_aCont($id);
	...
	function revisar($id){
		...
		$datos['identidad'] = $this -> Inicio_model -> get_identidad();
		$datos['usuario'] = $this -> Inicio_model -> get_usuario();
		$datos['conformidad'] = $this -> conformidades_model -> get_conformidades_revisar($id);
		$this -> load -> view('_estructura/header', $datos);
		$this -> load -> view('_estructura/top', $datos);
		$this -> load -> view('procesos/conformidades/revisar', $datos);
		$this -> load -> view('_estructura/right');
		$this -> load -> view('_estructura/footer');
	}
	//
	...
	// =======================================
	// Prueba Nueva Libreria PDF para resolver problemas de compatibilidad
	//
	// Fecha: 2018-07-08
	// =======================================

	public function documento($idc){
		...
		// Este método tiene varias opciones, consulta la documentación para más información.
				...
				$aCont = $aCon = $this->db->get_where('pa_conformidades_contencion', $condicion);
				foreach($aCont -> result() as $acont){
				...
				<table border="0" style="width:100%;">
					<tr>
						...
						<td style="background: #003A66; width: 90%; margin: 10px; text-align: center;">
							...
							<spam style="display: block; font-size: 10px; ">R10.2,A</spam>
						</td>
					...
					<table border="1" style="display: block; width:100%;">
						<tr style="background-color: #003A66; color: white;">
							<td style="background: #003A66; width: 100%; margin: 10px;" colspan="2">
								<spam style="display: block; margin-top: 150px; background: #003A66;">DATOS DE LA NO CONFORMIDAD</spam>
							</td>
						</tr>
						<tr>
							<td style="width: 30%; font-size: 12px;"> Folio: </td> <td style="width: 70%;"> '.$idc.'</td>
						</tr>
						<tr>
							<td style="font-size: 12px;">Usuario que levantó la No Conformidad:</td><td>'.$usuario.'</td>
						</tr>
						<tr>
							<td style="font-size: 12px;">Área: </td><td>'.$area.'</td>
						</tr>
						<tr>
							<td style="font-size: 12px;">Departamento: </td><td>'.$departamento.'</td>
						</tr>
						<tr>
							<td style="font-size: 12px;">Fecha: </td><td>'.$fecha.'</td>
						</tr>
						<tr>
							<td style="font-size: 12px;">Origen: </td><td>'.$origen.'</td>
						</tr>
						<tr>
							<td style="font-size: 14px;" colspan="2">Descripcion: </td>
						</tr>
						<tr>
						...
						<table border="1" style="display: block; width:100%;">
							<tr style="background-color: #003A66; color: white;">
								<td style="background: #003A66; width: 100%; margin: 10px;" colspan="2">
									<spam style="display: block; margin-top: 150px; background: #003A66;">Datos del Seguimiento de la No Conformidad</spam>
								</td>
							</tr>
							<tr>
								<td style="width: 30%; font-size: 12px;"> Acciones de Correcion: </td> <td style="width: 70%;"> '.$acont->Acciones.'</td>
							</tr>
							<tr>
								<td style="font-size: 12px;">Evidencia de Correccion:</td><td>'.$acont->Evidencia.'</td>
							</tr>';

							$html.= '<tr><td colspan="2">Diagrama de pescado: </td></tr>';

							if ($diagrama -> num_rows() > 0) {
								$i = 1;
								foreach ($diagrama->result() as $row) :
									$html .= '<tr>
															<td style="font-size: 12px; text-alig: justify;">'.$row->Categoria.'</td>

									';

									$html .= '
															<td style="font-size: 12px; text-alig: justify;">'.$row->Causa.'</td>
														</tr>
									';
								endforeach;
							}
							...
							$html .= '
							<tr>
								<td style="font-size: 12px;">Causa Raíz: </td>
								<td style="font-size: 12px;">'.$causas.'</td>
							</tr>
						</table>
							';
							...
							<table border="1" style="display: block; width:100%;">
								<tr style="background-color: #003A66; color: white;">
									<td style="background: #003A66; width: 100%; margin: 10px;" colspan="2">
										<spam style="display: block; margin-top: 150px; background: #003A66;">Acciones a Tomar</spam>
									</td>
								</tr>';
							...
							if ($acciones -> num_rows() > 0) {
								...
								$html .= '<tr>
														<td style="width: 30%; font-size: 12px;">Numero: </td><td style="width: 70%; font-size: 12px;">'.$i.'</td>
													</tr>
													<tr>
														<td style="font-size: 12px;">Fecha:</td><td style="font-size: 12px;">'.$fecha.'</td>
													</tr>
													<tr>
														<td style="font-size: 12px;">Tipo:</td><td style="font-size: 12px;">'.$row->Tipo.'</td>
													</tr>
													<tr>
														<td style="font-size: 12px;">Responsable:</td><td style="font-size: 12px;">'.$row->Responsable.'</td>
													</tr>
													<tr>
														<td style="font-size: 12px;">Accion:</td><td style="font-size: 12px;">'.$row->Accion.'</td>
													</tr>
								...
								<table border="1" style="display: block; width:100%;">
									<tr style="background-color: #003A66; color: white;">
										<td style="background: #003A66; width: 100%; margin: 10px;" colspan="2">
											<spam style="display: block; margin-top: 150px; background: #003A66;">Datos del Cumplimiento</spam>
										</td>
									</tr>
									<tr>
										<td style="font-size: 12px;" colspan="2">Nombre y Puesto del Auditor Responsable de vigilar el cumplimiento: </td>
									</tr>
									<tr>
										<td colspan="2"><br><br></td>
									</tr>
									<tr>
										<td colspan="2" style="font-size: 12px;">Evidencias Presentadas:</td>
									</tr>
									<tr>
										<td colspan="2">
											<br>
									...
									<tr>
										<td colspan="2" style="font-size: 12px;">Cumplio:</td>
									</tr>
									<tr>
										<td colspan="2"><br><br>
										Sí( )   No (  )    Fecha de Reprogramación: _________________
										<br>
										</td>
									</tr>
									<tr>
										<td colspan="2" style="font-size: 12px;">Comentarios: </td>
									</tr>
									<tr>
										<td colspan="2">
											<br>
									...
									<tr>
										<td colspan="2" style="font-size: 12px;">Firmas:</td>
									</tr>
									<tr>
										<td colspan="2" style="text-align: center;">
											...
											<br>
											<br>
											___________________________     &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;        ____________________________<br><br>
										&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Firma Auditor&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Firma del Responsable
										</td>
									</tr>
	...
	function documento_obs($idc) {
		...
		$pdf -> Cell(190, 10, 'No Conformidad R10.2,A', 1, 0, 'C', true);
		$pdf -> Ln();
		$pdf -> Ln(1);
		...
		$pdf -> Cell(190, 6, utf8_decode('Folio. '), 1, 0, 'L', true);
		$pdf -> Ln();
		$pdf -> SetFont("Arial", "", 12);
		$pdf -> WriteHTML(utf8_decode($idc));
		$pdf -> Ln();
		...
		$pdf -> Ln();
		$pdf -> SetFont("Arial", "B", 12);
		$pdf -> Cell(190, 6, utf8_decode('Correción'), 1, 0, 'L', true);
		$pdf -> Ln();
		$pdf -> SetFont("Arial", "", 12);
		$aCont = str_replace($search, $replace, $acont->Acciones);
		$pdf -> WriteHTML(strip_tags(iconv("UTF-8", "ISO-8859-1", $aCont)));
		$pdf -> Ln();
		// Evidencia de Acciones de Contencion
		$pdf -> Ln();
		$pdf -> SetFont("Arial", "B", 12);
		$pdf -> Cell(190, 6, utf8_decode('Evidencia de Acciones Correctivas'), 1, 0, 'L', true);
		$pdf -> Ln();
		$pdf -> SetFont("Arial", "", 12);
		$aCont = str_replace($search, $replace, $acont->Evidencia);
		$pdf -> WriteHTML(strip_tags(iconv("UTF-8", "ISO-8859-1", $aCont)));
		$pdf -> Ln();
		// diagrama de pescado
		$pdf -> Ln();
		...
		$pdf -> SetTextColor(255);
		$pdf -> SetFont("Arial", "B", 14);
		$pdf -> Cell(190, 10, 'Acciones Correctivas', 1, 0, 'C', true);
		$pdf -> Ln();
		$pdf -> Ln(1);
		$pdf -> SetFillColor(250, 250, 251);
		$pdf -> SetTextColor(0);
