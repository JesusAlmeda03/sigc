...
class TCPDF {
	...
	/**
	 * Array of object IDs for foreach page.
	 * @protected
	 */
	...
	/**
	 * If true reset the Header Xobject template at foreach page
	 * @protected
	 */
	...
	/**
	 * Array that contains the number of pages in foreach page group.
	 * @protected
	 * @since 3.0.000 (2008-03-27)
	 */
	...
	/**
	 * Array used to store footer positions of foreach page.
	 * @protected
...
Putting 1 is equivalent to putting 0 and calling Ln() just after. Default value: 0.
	...
	public function addHTMLTOC($page='', $toc_name='TOC', $templates=array(), $correct_align=true, $style='', $color=array(0,0,0)) {
		...
		$page_fill_start = false;
		$page_fill_end = false;
		// get the font type used for numbers in foreach template
	...
	/**
	 * Set columns array.
	 * foreach column is represented by an array of arrays with the following keys: (w = width, s = space between columns, y = column top position).
	 * @param $columns (array)
	 * @public
	 * @since 4.9.001 (2010-03-28)
	 */
	...
	*/
	 ...
	 * An XObject Template may be painted multiple times, either on several pages or at several locations on the same page and produces the same results foreach time, subject only to the graphics state at the time it is invoked.
	 ...
	 * @param $regions (array) array of no-write regions. For foreach region you can define an array as follow: ('page' => page number or empy for current page, 'xt' => X top, 'yt' => Y top, 'xb' => X bottom, 'yb' => Y bottom, 'side' => page side 'L' = left or 'R' = right). Omit this parameter to remove all regions.
	 * @author Nicola Asuni
	 * @public
	 * @since 5.9.003 (2010-10-13)
	 ...
	 * @param $palign (string) Allows to center or align the image on the current line. Possible values are:<ul><li>L : left align</li><li>C : center</li><li>R : right align</li><li>'' : empty string : left for LTR or right for RTL</li></ul>
	 * @param $border (mixed) Indicates if borders must be drawn around the cell. The value can be a number:<ul><li>0: no border (default)</li><li>1: frame</li></ul> or a string containing some or all of the following characters (in any order):<ul><li>L: left</li><li>T: top</li><li>R: right</li><li>B: bottom</li></ul> or an array of line styles for foreach border group - for example: array('LTRB' => array('width' => 2, 'cap' => 'butt', 'join' => 'miter', 'dash' => 0, 'color' => array(0, 0, 0)))
	 * @param $fitonpage (boolean) if true the image is resized to not exceed page dimensions.
	 * @author Nicola Asuni
	 * @since 5.0.000 (2010-05-02)
	 * @public
