                ...
                // Instructivos de Trabajo con permisos de CONTROLADOR DE DOCUMENTOS
                	if( $this->session->userdata('SOL') && $id == 1 ) {
						...
						foreach( $documentos->result() as $row ) {
							...
							if( $row->RutaWord != "" )
								echo '	<th><a href="'.base_url().'includes/docs/'.$row->RutaWord.'" onMouseover="ddrivetip(\''.$row->Nombre.'<br />en formato word\')"; onMouseout="hideddrivetip()" target="_blank"><img src="'.base_url().'includes/img/icons/doc.png" width="35" /></a></th>';							
							else
								echo '	<th><a onMouseover="ddrivetip(\'No se ha encontrado el<br />documento en formato word\')"; onMouseout="hideddrivetip()" target="_blank"><img src="'.base_url().'includes/img/icons/doc_notfound.png" width="35" height="35" /></a></th>';
							echo '		<th><a href="'.base_url().'includes/docs/'.$row->Ruta.'" onMouseover="ddrivetip(\''.$row->Nombre.'\')"; onMouseout="hideddrivetip()" target="_blank"><img src="'.base_url().'includes/img/icons/'.$ext.'.png" width="35" /></a></th>';				
