...
?>
	...
	<div class="content">
		<div class="cont">
			<div class="titulo"><?=$titulo?><br /><span style="font-size:22px"></span></div>
            <div class="texto">
                <?php
                $formulario = array(
		            // * Boton submit
				...
				if( $preguntas->num_rows() > 0 ) {							
					...
					echo '<tr><th width="200">N&uacute;mero total de usuarios encuestados:</th>';
				...
				<table><tr><td><a href="<?=base_url()?>index.php/evaluaciones/nueva_satisfaccion_sibib/presentacion" onmouseover="tip('Regresa al listado')" onmouseout="cierra_tip()"><img src="<?=base_url()?>includes/img/icons/back2.png"/></a></td><td valign="middle"><a href="<?=base_url()?>index.php/evaluaciones/nueva_satisfaccion_sibib/presentacion" onmouseover="tip('Regresa al listado')" onmouseout="cierra_tip()" style="letter-spacing:2px; padding-left:5px;">Regresar</a></td></tr></table>
			</div>
		</div>