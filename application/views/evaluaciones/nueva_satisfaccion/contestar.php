	...
	<div class="content">
		<div class="cont">
            ...
            <div class="texto">
				...
				<table><tr><td><a href="<?=base_url()?>index.php/evaluaciones/nueva_satisfaccion/presentacion" onmouseover="tip('Regresa al listado')" onmouseout="cierra_tip()"><img src="<?=base_url()?>includes/img/icons/back2.png"/></a></td><td valign="middle"><a href="<?=base_url()?>index.php/evaluaciones/nueva_satisfaccion/presentacion" onmouseover="tip('Regresa al listado')" onmouseout="cierra_tip()" style="letter-spacing:2px; padding-left:5px;">Regresar</a></td></tr></table>
			</div>
		</div>