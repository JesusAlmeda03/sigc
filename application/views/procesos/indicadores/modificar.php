	...
	<div class="content">		
		<div class="cont">
            ...
            <div class="texto">				            
	            <?php
	            if( $var == 'especiales' ) {
	            	$cancelar = 'location.href=\''.base_url().'index.php/procesos/indicadores/grafica_especiales/'.$id.'/'.$ano.'\'';
	            }
				else {
	            	$cancelar = 'location.href=\''.base_url().'index.php/procesos/indicadores/grafica/'.$id.'/'.$ano.'\'';
				}
				...
				echo '</table><br />';
				echo '<div style="width:670px; text-align:center;">'.form_submit($formulario['boton'],'Aceptar').form_button($formulario['boton_cancelar'],'Cancelar').'</div>';
				echo form_close();
                ?>                
        	</div>
    	</div>