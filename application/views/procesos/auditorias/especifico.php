	...
	<div class="content">		
		<div class="cont">
            ...
            <div class="texto">
				...
				?>
				<br /><br />
				<table><tr><td><a href="<?=base_url()?>index.php/listados/auditorias/<?=$ano?>/<?=$auditoria?>/<?=$estado?>" onmouseover="tip('Regresa al listado<br />de auditorias')" onmouseout="cierra_tip()"><img src="<?=base_url()?>includes/img/icons/back2.png"/></a></td><td valign="middle"><a href="<?=base_url()?>index.php/listados/auditorias/<?=$ano?>/<?=$auditoria?>/<?=$estado?>" onmouseover="tip('Regresa al listado<br />de auditorias')" onmouseout="cierra_tip()" style="letter-spacing:2px; padding-left:5px;">Regresar</a></td></tr></table>
			</div>
		</div>