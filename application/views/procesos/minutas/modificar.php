		...
		<div class="cont" style="min-height:200px">
            ...
            <div class="texto">
				...
				switch( $idp ) {
					// Lugar y Fecha
					case 10 :
						$formulario[$texto]['style'] = 'height:150px';						
						echo form_open('',array('name' => 'formulario', 'id' => 'formulario'));
						echo '<table class="tabla_form" width="700">';
						echo '<tr><th class="text_form" valign="top" style="padding-top:10px" width="70">'.$titulo_punto.': </th></tr>';
					...
					case 2 :						
						echo form_open('',array('name' => 'formulario', 'id' => 'formulario'));
						echo '<table class="tabla_form" width="700">';						
						echo '<tr><th width="20" style="background-color:#F8A4A7"><a class="iframe" href="'.base_url().'index.php/procesos/objetivos" onmouseover="tip(\'Abrir informaci&oacute;n de<br />los Objetivos de Calidad\')" onmouseout="cierra_tip()"><img src="'.base_url().'includes/img/icons/link.png" /></a></th><th class="text_form" valign="middle" style="padding-top:10px">'.$titulo_punto.': </th></tr>';				
					...
					case 3 :						
						echo form_open('',array('name' => 'formulario', 'id' => 'formulario'));
						echo '<table class="tabla_form" width="700">';
						echo '<tr><th width="20" style="background-color:#F8A4A7"><a class="iframe" href="'.base_url().'index.php/procesos/indicadores" onmouseover="tip(\'Abrir informaci&oacute;n de<br />los Indicadores\')" onmouseout="cierra_tip()"><img src="'.base_url().'includes/img/icons/link.png" /></a></th><th class="text_form" valign="middle" style="padding-top:10px">'.$titulo_punto.': </th></tr>';				
						echo '<tr><td colspan="2">'.form_textarea($formulario[$texto]).'</td></tr>';
						echo '</table>';
						echo '<div style="width:700px; text-align:center;">'.form_submit($formulario['boton'],'Aceptar').'</div>';
						echo form_close();
					...
					case 47 :						
						echo form_open('',array('name' => 'formulario', 'id' => 'formulario'));
						echo '<table class="tabla_form" width="700">';
						echo '<tr><th width="20" style="background-color:#F8A4A7"><a class="iframe" href="'.base_url().'index.php/listados/quejas/all/0" onmouseover="tip(\'Abrir informaci&oacute;n de<br />las Quejas\')" onmouseout="cierra_tip()"><img src="'.base_url().'includes/img/icons/link.png" /></a></th><th class="text_form" valign="middle" style="padding-top:10px">'.$titulo_punto.': </th></tr>';				
						echo '<tr><td colspan="2">'.form_textarea($formulario[$texto]).'</td></tr>';
						echo '</table>';
						echo '<div style="width:700px; text-align:center;">'.form_submit($formulario['boton'],'Aceptar').'</div>';
						echo form_close();
					...
					case 5 :
						echo form_open('',array('name' => 'formulario', 'id' => 'formulario'));
						echo '<table class="tabla_form" width="700">';
						echo '<tr><th width="20" style="background-color:#F8A4A7"><a class="iframe" href="'.base_url().'index.php/listados/conformidades/all/0" onmouseover="tip(\'Abrir informaci&oacute;n de<br />las No Conformidades\')" onmouseout="cierra_tip()"><img src="'.base_url().'includes/img/icons/link.png" /></a></th><th class="text_form" valign="middle" style="padding-top:10px">'.$titulo_punto.': </th></tr>';				
						echo '<tr><td colspan="2">'.form_textarea($formulario[$texto]).'</td></tr>';
						echo '</table>';
						echo '<div style="width:700px; text-align:center;">'.form_submit($formulario['boton'],'Aceptar').'</div>';
						echo form_close();
                ...
                ?>
                <table><tr><td><a href="<?=base_url()?>index.php/procesos/minutas/ver_modificar/<?=$idm?>/<?=$idmp?>/<?=$estado?>" onmouseover="tip('Regresa a la minuta')" onmouseout="cierra_tip()"><img src="<?=base_url()?>includes/img/icons/back2.png"/></a></td><td valign="middle"><a href="<?=base_url()?>index.php/procesos/minutas/ver_modificar/<?=$idm?>/<?=$idmp?>/<?=$estado?>" onmouseover="tip('Regresa a la minuta')" onmouseout="cierra_tip()" style="letter-spacing:2px; padding-left:5px;">Regresar</a></td></tr></table>
        </div>
    </div>