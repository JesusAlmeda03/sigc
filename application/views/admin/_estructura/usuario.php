            	...
            	<table width="970">
                	<tr>
                        ...
                        <td style="text-align:right" valign="top">
							...
							<a href="<?=base_url()?>index.php/inicio/logout" id="cerrar_sesion" onMouseover="tip('Cerrar tu sesi&oacute;n de<br />Administrador / Usuario')"; onMouseout="cierra_tip()"><img src="<?=base_url()?>includes/img/icons/small/logout.png" /></a>
						</td>
                    </tr>
                </table>
			</div>