...
?>
    <div class="cont" style="width:970px;">
        ...
        <div class="text">        	
			...
			?>
			<br /><br />        	
        	<table><tr><td><a href="<?=base_url()?>index.php/admin_files/minutas/puntos/<?=$per?>/<?=$ano?>" onmouseover="ddrivetip('Regresa al listado de minutas')" onmouseout="hideddrivetip()"><img src="<?=base_url()?>includes/img/icons/back2.png"/></a></td><td valign="middle"><a href="<?=base_url()?>index.php/admin_files/minutas/puntos/<?=$per?>/<?=$ano?>" onmouseover="ddrivetip('Regresa al listado de minutas')" onmouseout="hideddrivetip()" style="letter-spacing:2px; padding-left:5px;">Regresar</a></td></tr></table>
        </div>
