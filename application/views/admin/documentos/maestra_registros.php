...
/****************************************************************************************************
*
*	VIEWS/admin/documentos/maestra_registros.php
*
*		Descripci�n:
*			Vista de la lista maestra de registros
*
*		Fecha de Creaci�n:
*			21/Octubre/2011
*
    ...
    <div class="cont_admin">
        ...
        <div class="texto">
            ...
            if( $consulta->num_rows() > 0 ) {
				...
				echo '<th>Nombre</th><th>Retenci&oacute;n</th><th>Disposici&oacute;n</th><th>&Aacute;rea</th><th>Secci&oacute;n</th>';
...
/*						$doc = $row->Ruta;
					...
					if( !$this->session->userdata( 'ADI' ) ) {
						echo '<td width="24"><a href="'.base_url().'index.php/admin/documentos/modificar_documento/'.$row->IdDocumento.'/maestra_registros-'.$area.'" onMouseover="tip(\'Modificar\')" onMouseout="cierra_tip()"><img src="'.base_url().'includes/img/icons/modificar.png" /></a></td>';
						echo '<td width="24"><a onclick="pregunta_cambiar( \'documentos\', '.$row->IdDocumento.', 0, \'&iquest;Deseas eliminar este documento?\', \'documentos-maestra_registros-'.$area.'\')" onMouseover="tip(\'Eliminar\')"; onMouseout="cierra_tip()"><img src="'.base_url().'includes/img/icons/eliminar.png" /></a></td>';
					}
                    echo '</tr>';
                endforeach;
                echo '</tbody></table>';
