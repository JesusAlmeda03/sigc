		...
		// Tabla de resultados
				if( $busqueda ) {
                    if( $consulta->num_rows() > 0 ) {
                        ...
                        echo '<thead><tr><th class="no_sort" width="35"></th>';
                        ...
                        foreach( $consulta->result() as $row ) :
                            ...
                            echo '<td width="24"><a href="'.base_url().'index.php/admin/solicitudes/'.$solicitud.'/'.$row->IdDocumento.'" onMouseover="tip(\'Elegir documento para '.$solicitud.'\')"; onMouseout="cierra_tip()"><img src="'.base_url().'includes/img/icons/seguimiento.png" /></a></td>';
                            echo '</tr>';
                        endforeach;
                        echo '</tbody></table>';
						echo $sort_tabla;
                    	...
                    	echo '<table class="tabla" width="980"><tr><th width="20"><img src="'.base_url().'includes/img/icons/small/info.png" /></th><td>No se encontraron coincidencias con la b&uacute;squeda</td></tr></table>';
                    }
                }
                ?>
	        </div>
