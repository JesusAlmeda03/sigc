...
/** Funciones **/
	...
	function get_solicitudes( $edo, $tip ) {
		...
		$this->db->select('bc_documentos.IdDocumento,bc_documentos.Nombre,bc_documentos.Codigo,pa_solicitudes.IdSolicitud,pa_solicitudes.Estado,bc_documentos.Fecha,pa_solicitudes.Causas,pa_solicitudes.Solicitud');
