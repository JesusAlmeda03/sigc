	...
	_oExt.oPagination = {
		...
		"full_numbers": {
			...
			"fnInit": function ( oSettings, nPaging, fnCallbackDraw )
			{
				...
				nFirst.style.marginRight = '5px';
				nFirst.style.padding = '3px';
				nPrevious.style.marginRight = '5px';
				nPrevious.style.padding = '3px';				
				nNext.style.marginRight = '5px';
				nNext.style.padding = '3px';
				nLast.style.padding = '3px';				
			...
			"fnUpdate": function ( oSettings, fnCallbackDraw )
			{
				...
				for ( i=iStartButton ; i<=iEndButton ; i++ )
				{
					if ( iCurrentPage != i )
					{
						sList += '<span class="'+oClasses.sPageButton+'" style="padding:5px 10px; margin-right:5px; top:-5px">'+i+'</span>';
					}
					else
					{
						sList += '<span class="'+oClasses.sPageButtonActive+'" style="padding:5px 10px; margin-right:5px; top:-5px">'+i+'</span>';
					}
				}
	...
	$.fn.dataTable = function( oInit )
	{
		...
		function classSettings ()
		{
			...
			this.oLanguage = {
				...
				"sInfo": "_START_ a _END_ de un total de _TOTAL_ registros",
				...
				"sUrl": "",
				"oPaginate": {
					"sFirst":    "<img onMouseover=\"tip('Primera p&aacute;gina')\" onMouseout=\"cierra_tip()\" src='http://scalidad.ujed.mx/includes/img/paginas/first.png'>",
					"sPrevious": "<img onMouseover=\"tip('P&aacute;gina anterior')\" onMouseout=\"cierra_tip()\" src='http://scalidad.ujed.mx/includes/img/paginas/prev.png'>",
					"sNext":     "<img onMouseover=\"tip('P&aacute;gina siguiente')\" onMouseout=\"cierra_tip()\" src='http://scalidad.ujed.mx/includes/img/paginas/next.png'>",
					"sLast":     "<img onMouseover=\"tip('Ultima p&aacute;gina')\" onMouseout=\"cierra_tip()\" src='http://scalidad.ujed.mx/includes/img/paginas/last.png'>"
				},
				"fnInfoCallback": null
			};
		...
		function _fnFeatureHtmlFilter ( oSettings )
		{
			...
			sSearchStr = (sSearchStr.indexOf('_INPUT_') !== -1) ?
			  sSearchStr.replace('_INPUT_', '<input type="text" class="in_text" style="width:150px; margin:0;" />') :
			  sSearchStr==="" ? '<input type="text" class="in_text" style="width:150px; margin:0;" />' : sSearchStr+' <input type="text" class="in_text" style="width:150px; margin:0;" />';
			
			var nFilter = document.createElement( 'div' );
			nFilter.className = oSettings.oClasses.sFilter;
			nFilter.innerHTML = '<label class="text_form">'+sSearchStr+'</label>';
		...
		function _fnFeatureHtmlPaginate ( oSettings )
		{
			...
			nPaginate.style.margin = '-15px 5px 7px 0';
		...
		function _fnFeatureHtmlLength ( oSettings )
		{
			...
			var sStdMenu = '<select size="1" '+sName+' style="width:150px; font-size:12px; letter-spacing:0; margin:5px 0 0">';
			var i, iLen;
